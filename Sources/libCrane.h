// libCrane.h — API publique de Crane (opa334).
// Source : https://github.com/opa334/Crane-Resources
// Recuperee telle quelle, seuls les include guards et l import Foundation sont ajoutes.
